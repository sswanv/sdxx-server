...
const TypeId_ServerList = 167302817

func (*ServerList) GetTypeId() int32 {
    return 167302817
}

func NewServerList(_buf map[string]interface{}) (_v *ServerList, err error) {
    _v = &ServerList{}
    ...
    { var _ok_ bool; var __json_addr__ interface{}; if __json_addr__, _ok_ = _buf["addr"]; !_ok_ || __json_addr__ == nil { err = errors.New("addr error"); return } else { var __x__ string;  {  if __x__, _ok_ = __json_addr__.(string); !_ok_ { err = errors.New("__x__ error"); return } }; _v.Addr = __x__ }}
    return
}
