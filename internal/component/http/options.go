...
// WithJsonEncoder json编码器
func WithJsonEncoder(jsonEncoder utils.JSONMarshal) Option {
	return func(o *options) { o.jsonEncoder = jsonEncoder }
}

// WithJsonDecoder json解码器
func WithJsonDecoder(jsonDecoder utils.JSONUnmarshal) Option {
	return func(o *options) { o.jsonDecoder = jsonDecoder }
}
